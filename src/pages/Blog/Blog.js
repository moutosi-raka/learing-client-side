    ...
    return (
        <div className='w-2/3 mx-auto my-12'>
            <div className='border p-5 mb-8 '>
                <h3 className="text-2xl text-blue-300 mb-4">what is cors?</h3>
                <p>Cross-Origin Resource Sharing (CORS) is an HTTP-header based mechanism that allows a server to indicate any origins (domain, scheme, or port) other than its own from which a browser should permit loading resources. CORS also relies on a mechanism by which browsers make a "preflight" request to the server hosting the cross-origin resource, in order to check that the server will permit the actual request. In that preflight, the browser sends headers that indicate the HTTP method and headers that will be used in the actual request.</p>
            </div>
            <div className='border p-5 mb-8'>
                <h3 className="text-2xl text-blue-300 mb-4">Why are you using firebase? What other options do you have to implement authentication?</h3>
            ...
            <div className='border p-5 '>
                <h3 className="text-2xl text-blue-300 mb-4">How does the private route work?</h3>
            ...
            <div className='border p-5 '>
                <h3 className="text-2xl text-blue-300 mb-4">What is Node? How does Node work??</h3>
